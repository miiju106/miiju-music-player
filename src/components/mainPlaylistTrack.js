...
const MainPlaylistTrack = ({playlistTracks, mainPlaylist, currentMainPlaylist }) => {
...
<div className='playlist-body' onClick={() => playPlaylist(currentMainPlaylist.id, currentMainPlaylist.name)}>
